...
public class ProductServiceImpl implements ProductService{
	...
	public ProductDto saveProduct(ProductDto productDto) {
		...
		SavePriceDto pricerequest = new SavePriceDto();
		pricerequest.setCurrency( priceDto.getCurrency());
		pricerequest.setAmount( priceDto.getAmount());
		pricerequest.setProductName( savedProduct.getProductname());
		savedproductDto.setPrice( priceAPIClient.savePrice(pricerequest));
		...
		SaveInventoryDto inventoryrequest = new SaveInventoryDto();
		inventoryrequest.setTotal(inventoryDto.getTotal());
		inventoryrequest.setAvailable( inventoryDto.getAvailable());
		inventoryrequest.setReserved( inventoryDto.getReserved());
		inventoryrequest.setProductName(savedProduct.getProductname());
		savedproductDto.setInventory(inventoryAPIClient.saveInventory(inventoryrequest));
